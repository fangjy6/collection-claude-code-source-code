"""Thread-safe task store: in-memory dict persisted to .clawnest/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.clawnest/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".clawnest" / "tasks.json"
