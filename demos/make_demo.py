#!/usr/bin/env python3
"""
Generate animated GIF demo of clawnest using PIL.
...
def build_scenes():
    ...
    response_lines = [
        ...
        " 553  clawnest.py — REPL entry point, slash commands, rich rendering",
        "────────────────────────────────────────────────────",
        "1261  total",
        "",
        "The largest file is `clawnest.py` containing the interactive REPL,",
    ...
    msg2 = "Write a hello_world.py that prints 'Hello from ClawNest!'"
    ...
    resp2 = [
        ...
        "",
        "  print('Hello from ClawNest!')",
        "",
        "Output: Hello from ClawNest!",
    ]
    tool2 = [
        tool_line("⚙", "Write", "/tmp/hello_world.py", MAUVE),
        tool_ok("Wrote 3 lines to /tmp/hello_world.py"),
...
def render_screenshot(output_path="screenshot.png"):
    ...
    lines = (
        ...
        [
            ...
            text_line(" 553  clawnest.py — REPL + slash commands", 2),
            text_line("────────────────────────────────", 2),
            text_line("1261  total", 2),
            None,
            text_line("The main entry point `clawnest.py` contains the REPL,", 2),
