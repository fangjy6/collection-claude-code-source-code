# Claude Code vs ClawNest v3.03: Comparative Analysis
...
**ClawNest**: `rich` library, Markdown syntax highlighting — simple but sufficient
...
5. **Markdown Skills** — Custom skills via `~/.clawnest/skills/*.md` without touching source code
