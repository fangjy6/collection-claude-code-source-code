# Claude Code vs ClawNest v3.03：对比分析

## 整体概览

| 维度 | Claude Code (TypeScript) | ClawNest (Python) |
|------|--------------------------|---------------------------|
...
**ClawNest**：`rich` 库，Markdown 语法高亮，简单但够用
...
5. **Markdown Skills** — `~/.clawnest/skills/*.md` 可自定义技能，无需改代码
...
ClawNest 是对 Claude Code 核心理念的**极简复现**，在多提供商支持和代码可读性上超越了原版，非常适合作为研究基础或个人工具。Claude Code 则是完整的工程产品，在 UI、安全、企业功能上不可比拟。
